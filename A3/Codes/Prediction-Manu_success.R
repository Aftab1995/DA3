...
#           Khawaja Hassan              #
#                                       #
#   Prediction on bisnode-firm data     #
#            Manufacturing              #
#########################################
...
# separate datasets  (train and holdout) -------------------------------------------------------
 ...
 #                 $fast_growth_f)
# 
#  saveRDS(data_train,"data_train_m.RDS")
#  saveRDS(data_holdout,"data_holdout_m.RDS")



data_train <- readRDS("data_train_m.RDS")
data_holdout <-readRDS("data_holdout_m.RDS")
...
prevelance1 = sum(data_holdout$fast_growth)/length(data_holdout$fast_growth)
...
model_names <- c("Logit X1", "Logit X2", "Logit X3","Logit X4","Logit X4",
...
combined_manu <- kable(am,"latex",longtable =T,booktabs =T,caption ="Confusion Table ~ Manufacturing",digits = 2)%>%
