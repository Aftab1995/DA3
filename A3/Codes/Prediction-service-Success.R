...
b1 <- as.data.frame.matrix(cm1_perc)
b2 <- as.data.frame.matrix(cm_rf_perc)
bm <- cbind(b1,b2)

combined_service <- kable(bm,"latex",longtable =T,booktabs =T,caption ="Confusion Table ~ Service",digits = 2)%>%
