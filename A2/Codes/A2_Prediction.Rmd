...
data_test <- readRDS(gzcon(url("https://github.com/Aftab1995/DA3/blob/main/A2/data_train.RDS?raw=true")))
#####################
...
```{r,echo=FALSE, warning=FALSE, message=FALSE}
price_diff_by_variables2(data, "f_property_type", "d_first_aid_kit", "Property Type", "First Aid Kit Available?")

price_diff_by_variables2(data, "f_property_type", "d_dishes_and_silverware", "Property Type", "Dishes & Silverware Available?")
...
```{r,echo=FALSE, warning=FALSE, message=FALSE}
result %>% kbl(caption = "Horse Race of Models - Training data CV RSME", escape = FALSE) %>% 
  kable_classic(full_width = F, html_font = "Cambria") %>%
  kable_styling( position = "right")

result_2 %>% kbl(caption = "Horse Race of Models -  Holdout dataset RSME", escape = FALSE) %>% 
  kable_classic(full_width = F, html_font = "Cambria") %>%
...
```{r,echo=FALSE, warning=FALSE, message=FALSE}
result_3 %>% kbl(caption = "Subsample Analysis", escape = FALSE) %>% 
  kable_classic(full_width = F, html_font = "Cambria", ) %>%
...
level_vs_pred <- ggplot() +
 ...
 axis.title.y = element_text(size = 11, face = "bold"), axis.title.x = element_text(size = 11, 
 face = "bold")) +
